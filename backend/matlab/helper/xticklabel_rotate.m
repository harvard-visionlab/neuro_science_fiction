...
%
% Example 1:  Rotate existing XTickLabel at their current position by 90
%    xticklabel_rotate
%
% Example 2:  Rotate existing XTickLabel at their current position by 45 and change
% font size
...
if length(XTick) ~= length(XTickLabel),
...
% Place the new XTickLabel by creating TEXT objects
